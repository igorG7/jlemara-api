// ─────────────────────────────────────────────────
// Resposta da API UAU — Obras/ObterObrasAtivas (listagem)
// ─────────────────────────────────────────────────

export type ResponseFindAllDevelopments = {
    Cod_obr: string;
    Empresa_obr: number;
    Descr_obr: string;
    Status_obr: number;
...
// ─────────────────────────────────────────────────
// Resposta da API UAU — Obras/ObterObrasAtivas (detalhe)
// ─────────────────────────────────────────────────

export type ResponseFindDevelopmentByCode = {
    cod_obr: string;
    Fisc_obr: string;
    descr_obr: string;
    ender_obr: string;
