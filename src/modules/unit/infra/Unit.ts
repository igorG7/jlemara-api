...
import { IPhoto, IUnit } from "../domain/unit.interface";
...
const UnitSchema = new Schema<IUnit>(
  {
    ...
    product_unit: { type: Number, required: true },
    unit_code: { type: Number, required: true },
    development_code: { type: String, trim: true, required: true },
    ...
    unit_identifier: { type: String, required: true, trim: true },
    // photos: { type: [PhotosSchema], default: [] },
    district: { type: String, trim: true, default: "" },
    city: { type: String, trim: true, default: "" },
    latitude: { type: String, default: "" },
    longitude: { type: String, default: "" },
    sale_number: { type: String, required: true, default: "0" },
    uau_ref: { type: String, required: true },
